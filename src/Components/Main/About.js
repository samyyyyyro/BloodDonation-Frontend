  ...
  return (
    <div className='px-44'>
      ...
      <p className='text-right text-5xl'>
        <br />
        <a target="_blank" href="https://github.com/samyyyyyro" className='hover:drop-shadow-md hover:text-purple'><i class="fa-brands fa-github"></i></a>&nbsp;&nbsp;&nbsp;
        <a target="_blank" href="https://www.linkedin.com/in/samyak-mathur-3b540a264/" className='hover:drop-shadow-md hover:text-metal'><i class="fa-brands fa-linkedin"></i> </a>&nbsp;&nbsp;
      </p>
    </div>
  )
}
